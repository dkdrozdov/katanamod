...
public abstract class KatanaItem extends Item {
    ...
    public KatanaItem(int attackDamage, float attackSpeed, Item.Settings settings, Katana katana) {
    ...
    private void registerOnKilledEntityAbilities() {
        ...
        List<KillAbility> abilities = katana.getKillAbilities();
    ...
    private void registerTickAbilities() {
        List<TickAbility> abilities = katana.getTickAbilities();
    ...
    private void registerAttackAbilities() {

        OnAttackCallback.ON_CRIT_ATTACK_CALLBACK_EVENT.register((Entity target, PlayerEntity attacker) -> {
