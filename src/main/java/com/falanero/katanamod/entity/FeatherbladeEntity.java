...
//        entityHitResult.getEntity().clientDamage(DamageSource.thrownProjectile(this, this.getOwner()), 0.0f);
//    }
//
...
//                    this.world.addParticleClient(ParticleTypes.EXPLOSION,
...
//            this.world.addParticleClient(ParticleTypes.SWEEP_ATTACK,
//                    pos.x + particlePos.x,
//                    pos.y + particlePos.y,
//                    pos.z + particlePos.z,
//                    velocity.x,
...
//
//        this.world.addParticleClient(ParticleTypes.POOF,
...
//                    livingEntity.clientDamage(DamageSource.player((PlayerEntity) owner), damage);
//                }
//            }
//        }
//    }
...
//    @Override
//    @Nullable
//    public Entity teleportTo(ServerWorld destination) {
//        Entity entity = this.getOwner();
